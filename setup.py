...
if __name__ == '__main__':
    ...
    write_version_to_file(version, 'rd3d/version.py')
    ...
    setup(
        ...
        ext_modules=[
            ...
            make_cuda_ext(
                ...
                module='rd3d.ops.roiaware_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='rd3d.ops.roipoint_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='rd3d.ops.pointnet2.pointnet2_stack',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='rd3d.ops.pointnet2.pointnet2_batch',
                sources=[
                    'src/pointnet2_api.cpp',
                    'src/ball_query.cpp',
                    'src/ball_query_gpu.cu',
