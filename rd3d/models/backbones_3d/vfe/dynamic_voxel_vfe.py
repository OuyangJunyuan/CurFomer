...
class DynamicVoxelVFE(VFETemplate):
    def __init__(self, model_cfg, num_point_features, voxel_size, grid_size, point_cloud_range, **kwargs):
        ...
        self.num_point_features = self.num_filters[-1] if self.num_filters else num_point_features
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        batch_dict['voxel_numbers'] = torch.bincount(voxel_coords[:, 0]).int()
        batch_dict['point_coords'] = points_mean.detach().clone()
        return batch_dict
