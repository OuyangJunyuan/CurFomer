...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.class_names = model_cfg.get('CLASS_NAMES', dataset.class_names)
        self.register_buffer('global_step', torch.LongTensor(1).zero_())

        self.module_topology = [
            'vfe', 'backbone_3d', 'neck', 'pfe',
    ...
    def build_neck_module(self, model_info_dict):
    ...
    def build_neck(self, model_info_dict):
        if 'MAP_TO_BEV' in self.model_cfg:
            return self.build_map_to_bev_module(model_info_dict)
        if 'NECK' in self.model_cfg:
            return self.build_neck_module(model_info_dict)
        return None, model_info_dict
    ...
    def build_dense_head(self, model_info_dict):
        ...
        dense_head_module = dense_heads.__all__[self.model_cfg.DENSE_HEAD.NAME](
            ...
            input_channels=model_info_dict.get('num_bev_features', self.model_cfg.DENSE_HEAD.get('INPUT_FEATURES')),
