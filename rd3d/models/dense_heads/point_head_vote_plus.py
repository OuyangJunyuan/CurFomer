...
from ..backbones_3d.pfe.ops import SAMPLERS
...
class PointHeadVotePlus(PointHeadTemplate):
    ...
    def __init__(self, num_class, input_channels, model_cfg, predict_boxes_when_training=False, **kwargs):
        ...
        self.vote_sampler = SAMPLERS.build_from_cfg(self.model_cfg.VOTE_SAMPLER, input_channels=input_channels)
        ...
        self.shared_layers = self.make_fc_layers(fc_list=[input_channels] + self.model_cfg.SHARED_FC)
    ...
    def forward(self, batch_dict):
        ...
        if not self.training or self.predict_boxes_when_training:
            ...
            if not torch.onnx.is_in_onnx_export():
                ...
                batch_dict['batch_box_preds'] = torch.cat([point_box_preds, point_label_preds], dim=-1)
        return batch_dict
