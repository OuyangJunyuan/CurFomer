...
from ...core.base import dist
from ...core import create_logger, table_string
...
class InstanceBank(object):
    ...
    def __init__(self, bank_cfg, root_dir=None, class_names=None):
        ...
        self.logger = create_logger("bank", file=self.pseudo_db_path / "../log.txt", scene=False)
        ...
        self.logger.info(table_string(dict(
            ...
            pseudo_db_path=self.pseudo_db_path), hFeader=['bank', 'value']))
