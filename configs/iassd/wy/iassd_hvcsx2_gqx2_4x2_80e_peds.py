...
MODEL = dict(
    ...
    BACKBONE_3D=dict(
        ...
        ENCODER=
        [
            dict(samplers=[dict(name='havs', sample=16384, voxel=[0.3, 0.3, 0.3], return_hash=True)],
            ...
            dict(samplers=[dict(name='havs', sample=4096, voxel=[1.0, 1.0, 1.0], return_hash=True)],
