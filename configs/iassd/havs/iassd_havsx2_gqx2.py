...
MODEL = dict(
    ...
    BACKBONE_3D=dict(
        ...
        ENCODER=
        [
            dict(samplers=[dict(name='havs', sample=4096, voxel=[0.4, 0.4, 0.35], return_hash=True)],
            ...
            dict(samplers=[dict(name='havs', sample=1024, voxel=[2.0, 2.0, 1.75], return_hash=True)],
            ...
            dict(samplers=[dict(name='ctr', sample=512, mlps=[128], class_names=DATASET.CLASS_NAMES,
    ...
    POINT_HEAD=dict(
        ...
        VOTE_SAMPLER=dict(name='ctr', sample=256, mlps=[256], class_names=DATASET.CLASS_NAMES,
                          train=dict(target={'extra_width': [0.5, 0.5, 0.5]},
