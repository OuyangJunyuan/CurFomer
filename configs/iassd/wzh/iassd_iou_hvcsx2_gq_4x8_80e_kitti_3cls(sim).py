from ..base.datasets.kitti_3cls_fov360 import *
...
MODEL = dict(
    ...
    BACKBONE_3D=dict(
        ...
        ENCODER=
        [
            dict(samplers=[dict(name='fps', sample=4096, voxel=[0.4, 0.4, 0.35])],
            ...
            dict(samplers=[dict(name='fps', sample=1024, voxel=[2.0, 2.0, 1.75])],
